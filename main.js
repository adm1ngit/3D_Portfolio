...
let projects = [
  {
    ...
    url: 'https://github.com/adm1ngit/SpringMVC_CRUD_with_MySQL',
  },
  {
    image: 'textures/project-myteachers.jpg',
    url: 'https://github.com/adm1ngit/Backend_Movie',
  },
  {
    image: 'textures/project-wholesale.jpg',
    url: 'https://github.com/adm1ngit/NoxonFx_Backend',
  },
  {
    image: 'textures/project-pelotero.jpg',
    url: 'https://github.com/adm1ngit/CRM_-Django-',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry("Sobirov O'tkir ", {
      font: font,
      size: 0.08,
      height: 0.01,
    });
